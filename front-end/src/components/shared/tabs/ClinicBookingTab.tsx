...
const ClinicBookingTab: FC = () => {
    ...
    return <div className="flex flex-col gap-y-10 w-[800px]">
        <div className="flex flex-col gap-y-1 items-start">
            <span className="text-2xl font-semibold">Đa dạng phòng khám</span>
            <p className="text-left font-medium text-gray-600">Đặt khám dễ dàng và tiện lợi hơn với các phòng khám cùng nhiều chuyên khoa</p>
        </div>
