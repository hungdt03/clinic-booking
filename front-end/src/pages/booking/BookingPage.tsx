...
const BookingPage: FC = () => {
    ...
    return <div className="flex flex-col">
        ...
        />
        <div className="flex flex-col items-center gap-y-16 py-8 w-[1200px] mx-auto">
            <div className="flex items-center w-full">
                <Link to='/booking/doctor' className={cn('flex-1 flex justify-center items-center gap-x-1 text-[17px] border-b-[2px] py-3 hover:border-primary', location.pathname.includes('/booking/doctor') ? 'border-primary text-primary' : ' border-blue-200')}>
                    <img alt="Bác sĩ" className="w-6 h-6" src={images.medicalOutline} />
                    <span>Đặt khám bác sĩ</span>
                </Link>
                <Link to='/booking/clinic' className={cn('flex-1 flex justify-center items-center gap-x-1 text-[17px] border-b-[2px] py-3 hover:border-primary', location.pathname.includes('/booking/clinic') ? 'border-primary text-primary' : ' border-blue-200')}>
